    ...
    <section id="about" className="py-20 md:py-32 relative">
      <div className="container mx-auto px-4 sm:px-6">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
          <span className="inline-block px-4 py-2 bg-gradient-to-r from-cyan-500/10 to-purple-500/10 text-cyan-400 rounded-full text-sm font-semibold mb-4">About Farhan Ahmed Anik</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="bg-gray-800/30 p-5 rounded-xl border border-cyan-500/20">
                <div className="flex items-center gap-3 mb-3">
                  <FaShieldAlt className="text-cyan-400 text-xl" />
                  <h4 className="text-xl font-semibold text-cyan-300">Beyond the Code</h4>
                </div>
                <p className="text-gray-300">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-12">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="text-2xl sm:text-3xl font-bold text-cyan-400 mb-2">{stat.value}</div>
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}>
            <div className="mb-10 p-6 bg-gradient-to-br from-gray-800/40 to-cyan-900/20 rounded-xl border border-cyan-500/20">
              <div className="flex items-center gap-3 mb-4">
                <FaTerminal className="text-cyan-400 text-2xl" />
                <h4 className="text-xl font-semibold">My Philosophy</h4>
              </div>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  whileHover={{ y: -10 }}
                  className="p-6 bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-xl border border-gray-700/50 hover:border-cyan-500/30 transition-all group"
                >
                  <div className="text-3xl text-cyan-400 mb-4 group-hover:text-cyan-300 transition-colors">{feature.icon}</div>
            ...
            <motion.div
              ...
              className="mt-10 p-5 bg-gradient-to-r from-purple-900/20 to-cyan-900/20 rounded-xl border border-purple-500/20"
            >
